...
public class Task04 {
    public static void main(String[] args) {
        ...
        double totalHealthPoints = (double) healthPoints;

        for (int i = 1; i <= hoursAfterRespawn; i++) {
            totalHealthPoints = (totalHealthPoints + (totalHealthPoints * regenerationPercentFromCurrentHealth / 100));

        }
        System.out.println((int) totalHealthPoints);
    }
}