...
public class CensorDemo {
    ...
    public static void main(String[] args) {
        ...
        String filePathCensored = "E:" + File.separator + "home" + File.separator + "portnova" + File.separator + "course-java-basics" + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "newfile_.txt";
        SearcherRunnable searcher = new SearcherRunnable(dirForSearch, wordForSearch);
        Thread threadSearcher = new Thread(searcher);
        ResetRunnable resetRunnable = new ResetRunnable(filePathForbiddenWords, filePathNewFile, filePathCensored);
